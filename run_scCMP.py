...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="scCMP")
    parser.add_argument('--gpu', type=int, default=0, help='which GPU to use.')
    parser.add_argument('--epochs', type=int, default=150, help='number of epoches to train the scCMP.')
    parser.add_argument('--lr', type=float, default=0.0001, help='learning rate.')
    parser.add_argument('--latent_dim', type=int, default=50, help='the latent dimension.')
    parser.add_argument('--w', type=float, default=1, help='the hyperparameter lambda.')
